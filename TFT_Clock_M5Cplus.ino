...
void setup(void) {
  ...
  // Draw clock face
  M5.Lcd.fillCircle(70, 120, 60, TFT_GREEN);
  M5.Lcd.fillCircle(70, 120, 56, TFT_BLACK);
  ...
  M5.Lcd.fillCircle(70, 120, 2, TFT_WHITE);
...
void loop() {
  if (targetTime < millis()) {
    ...
    if (ss==0 || initial) {
      ...
      M5.Lcd.drawLine(ohx, ohy, 70, 120, TFT_BLACK);
      ohx = hx*25+70;    
      ohy = hy*25+120;
      M5.Lcd.drawLine(omx, omy, 70, 120, TFT_BLACK);
      omx = mx*30+70;    
      omy = my*30+120;
    }

      // Redraw new hand positions, hour and minute hands not erased here to avoid flicker
      M5.Lcd.drawLine(osx, osy, 70, 120, TFT_BLACK);
      osx = sx*40+70;    
      osy = sy*40+120;
      M5.Lcd.drawLine(osx, osy, 70, 120, TFT_RED);
      M5.Lcd.drawLine(ohx, ohy, 70, 120, TFT_WHITE);
      M5.Lcd.drawLine(omx, omy, 70, 120, TFT_WHITE);
      M5.Lcd.drawLine(osx, osy, 70, 120, TFT_RED);
      M5.Lcd.fillCircle(70, 120, 2, TFT_RED);
  }
}
